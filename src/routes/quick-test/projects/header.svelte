...
let tabs = [
    ...
    { name: 'Test Runs', href: '/quick-test/projects/1/testruns', current: selection === 'Test Runs' },
    ...
    { name: 'Milestones', href: '/quick-test/projects/1/milestones', current: selection === 'Milestones' },
