<aside class="px-2 py-6 sm:px-6 lg:py-0 lg:px-0 lg:col-span-3">
	<nav class="space-y-1">
		<a
			...
			<span class="truncate ml-2"> Archived Users </span>
		</a>
		<a
			...
			<span class="truncate ml-2"> Archived Roadmaps </span>
		</a>
		<a
			...
			</svg> <span class="truncate ml-2"> Archived Courses </span>
		</a>
		<a
			href="/quick-learn/settings/profile/preferences"
			class="text-gray-900 hover:text-gray-900 hover:bg-gray-50 rounded px-3 py-2 flex items-center text-sm font-medium">
			...
			<svg
				...
				<path
					...
					stroke-width="2"
					d="M15 4h3c.6 0 1 .4 1 1v15c0 .6-.4 1-1 1H6a1 1 0 0 1-1-1V5c0-.6.4-1 1-1h3m0 3h6m-6 7 2 2 4-4m-5-9v4h4V3h-4Z" />
			</svg> <span class="truncate ml-2"> Archived Lessons </span>
		</a>
	</nav>
</aside>
