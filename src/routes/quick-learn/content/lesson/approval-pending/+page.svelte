<main>
	<div class="bg-gray-50 relative z-0 flex-1 overflow-x-scroll focus:outline-none h-screen">
			...
			<nav class="flex" aria-label="Breadcrumb">
				<ol class="inline-flex justify-self-center space-x-1 md:space-x-2 rtl:space-x-reverse">
					<li class="inline-flex items-center">
						<a
							href="/quick-learn/team/1/roadmaps"
		...
		<div class="flex items-center p-16 mb-16 w-full max-w-5xl justify-center mx-auto">
			<div
				class="flex items-center p-4 mb-4 text-sm text-yellow-800 rounded-lg bg-yellow-50 dark:bg-gray-800 dark:text-green-400"
				role="alert">
				<svg
				...
				<div class="text-xl">
					<span class="font-medium text-lg">Approval Pending!</span> This lesson is awaiting approval
					from the team. After approval this will be available to all the team members.
				</div>
			</div>
		</div>
	</div>
