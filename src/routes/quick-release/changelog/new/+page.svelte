<script>
	import Fullnavbar from '$lib/quick-release/fullnavbar.svelte';
...
<main class="mx-auto max-w-2xl px-4 pt-10 pb-12 lg:pb-16">
	<form>
		<div class="space-y-6">
			...
			<div>
				...
				<div class="mt-2">
					<textarea
						...
						name="description"
						rows="3"
						class="block w-full h-56 rounded-md border-0 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-sky-500 sm:py-1.5 sm:text-sm sm:leading-6" />
				</div>
			</div>
			...
			<div>
				...
				<div class="mt-2">
					<input
						...
						name="project-name"
						id="project-name"
						class="px-2 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-sky-500 sm:text-sm sm:leading-6"
						value=""
						placeholder="1.0.0" />
				</div>
			</div>
			...
			<fieldset>
				<label for="project-name" class="block text-sm font-medium leading-6 text-gray-900"
					>Release Categories (Optional)</label>
					...
					<div class="relative flex items-start">
						<div class="flex h-6 items-center">
							<input
								...
								name="comments"
								type="checkbox"
								class="h-4 w-4 rounded border-green-300 text-green-600 focus:ring-green-600" />
						</div>
					...
					<div class="relative flex items-start">
						<div class="flex h-6 items-center">
							<input
								...
								name="comments"
								type="checkbox"
								class="h-4 w-4 rounded border-yellow-300 text-yellow-600 focus:ring-yellow-600" />
						</div>
						<div class="ml-1 text-sm leading-6">
							<span
			...
			<div>
				<label for="tags" class="block text-sm font-medium leading-6 text-gray-900"
					>Release Tags (Optional)</label>
				<input
					type="text"
					name="tags"
					id="tags"
					class="mt-2 block w-full rounded-md border-0 py-1.5 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-sky-500 sm:text-sm sm:leading-6" />
			</div>
			...
			<div class="flex justify-end gap-x-3">
				<a href="/quick-release/changelog">
					<button
						type="button"
