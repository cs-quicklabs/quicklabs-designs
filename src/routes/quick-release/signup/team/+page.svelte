					...
					<div class="w-full sm:max-w-xs">
						...
						<div class="mt-1 flex rounded-md shadow-sm">
							<span
								...
								>release.quicklabs.in/</span>
							<input
								type="text"
								name="company-website"
								id="company-website"
								class="border block w-full min-w-0 flex-1 rounded-none rounded-r-md border-gray-300 px-3 py-2 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
								placeholder="skia" />
						</div>
					</div>
					<button
