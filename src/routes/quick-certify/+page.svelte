<script>
	...
	let credential = [{ title: 'Credential', link: '/quick-certify/credential' }];
	...
	let thirdColumnWorkflows = [{ title: 'Pathways', screens: pathways }];

	// WorkflowColumns
	const workflowColumns = [settingWorkflows, publicWorkflows, thirdColumnWorkflows];
</script>
...
<div class="mx-auto w-full flex-grow lg:flex">
	...
	<div class="min-w-0 flex-1 bg-white xl:flex">
		{#each workflowColumns as columnData}
			<div
				class="border-b border-gray-200 bg-white xl:w-64 xl:flex-shrink-0 xl:border-b-0 border-r">
				<div class="h-full sm:pl-6 lg:pl-8 xl:pl-0">
					<!-- Start left column area -->
					<div class="relative">
						{#each columnData as workflow}
							<div
