...
<main>
	<section class="min-h-screen">
		<div class="py-6 px-4 mx-auto max-w-2xl lg:py-8">
			<!-- Heading -->
			<div class="mb-6">
				<h1 class="form-title">Edit Pathway</h1>
				<p class="form-subtitle">
					Update the pathway details, credentials, and their order.
				</p>
			</div>
			...
			<form action="/quick-certify/pathways" method="GET">
				...
				<div class="mb-6">
					...
					<textarea
						...
						rows="3"
						class="form-input-field w-full"
						>Master the fundamentals of full-stack web development from front-end frameworks to back-end databases.</textarea>
				...
				<div class="flex items-center justify-between pt-2">
					<button type="submit" class="btn-primary"> Update & Activate </button>
