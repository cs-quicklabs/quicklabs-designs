	...
	<div class="lg:grid lg:grid-cols-12 lg:gap-x-5">
		...
		<main class="max-w-xl px-4 pb-12 lg:col-span-8">
				...
				<div class="flex space-x-4 ml-4 mb-4">
					<div class="flex-2 min-w-0" data-behavior="autocomplete" data-controller="nav-search" data-nav-search-url-value="/search/deactivated">
	...
	<div class="relative w-full max-w-md max-h-full">
		<div class="relative bg-white rounded-lg shadow dark:bg-gray-700 text-center p-5">
			...
			<div class="flex justify-center mt-4">
				<button data-modal-hide="popup-modal" class="btn-red text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5">Yes, Delete</button>
				<button data-modal-hide="popup-modal" class=" btn-secondary ml-3 text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-lg px-5 py-2.5 hover:bg-gray-100 hover:text-blue-700">No, Cancel</button>
			</div>
		</div>
	</div>
</div>
	...
	<div class="relative w-full max-w-md max-h-full">
		<div class="relative bg-white rounded-lg shadow dark:bg-gray-700 text-center p-5">
			<button data-modal-hide="popup-modal-activate" class="btn-secondary absolute top-3 right-2.5 ">
				...
				<span class="btn-secondary sr-only">Close modal</span>
			</button>
			...
			<div class="flex justify-center mt-4">
				...
				<button data-modal-hide="popup-modal-activate" class="btn-secondary ml-3 text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-lg px-5 py-2.5 hover:bg-gray-100 hover:text-blue-700">No, Cancel</button>
			</div>
		</div>
	</div>
</div>
